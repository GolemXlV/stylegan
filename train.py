...
if 1:
    ...
    # desc += '-8gpu'; submit_config.num_gpus = 8; sched.minibatch_base = 32; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 128, 64: 64}

    # Default options.
    train.total_kimg = 25000
    sched.lod_initial_resolution = 8
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
    # sched.G_lrate_dict = {32: 0.0015, 128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
...
def main():
    ...
    kwargs.update(resume_run_id=3, resume_kimg=10449, resume_snapshot=10449)
